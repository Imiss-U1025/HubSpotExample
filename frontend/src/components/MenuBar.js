    ...
    return (
      <div className='w-full  '>
        <div className="flex justify-between items-center px-10 border-b-2 border-gray-200">
          ...
          <div>
          <button className='min-w-[8%] h-[100%] mr-5 p-2 border-[1.5px] border-[#CBD6E2] bg-[#EAF0F5] rounded-sm text-[#4F6E91] text-sm'>Send Email</button>
          <button className='min-w-[8%] h-[100%] mr-5 p-2 border-[1.5px] border-[#CBD6E2] bg-[#EAF0F5] rounded-sm text-[#4F6E91] text-sm'>Actions</button>
          </div>
